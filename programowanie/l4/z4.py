...
def graf(rodzaj, n, p=0.4,k=1):
  ...
  if rodzaj == "R":
    ...
    #nazwa="W"
  # tu jeszcze muszę się zstanowić
  elif rodzaj == "B":
  ...
  imageio.mimsave(r"C:\Users\dell\Desktop\marysia\studia\programowanie\grafy.gif",listagif,loop=0, duration=800)
  print("koniec")
graf("W",6,0.7,2)
